...
public class Lots {
      ...
      public static void searchFilter(String text, ArrayList<String> list, DefaultListModel dlm, JList jl) {
      ...
      public static void ky3(JList lst, JTextField tf, ArrayList<String> list, DefaultListModel dlm,
            ...
            if (ev.getKeyCode() == KeyEvent.VK_LEFT //TAG SYSTEM FOR SEARCHFILTER
                  ...
                  if (tf.getText().contains("; ")) {
                        ...
                        searchFilter(tf.getText(), list, dlm, lst);
                  }
